...
echo $Generator->loadProgramDescription("programs.yml", "Be Prepared");

?>
            <article class="note">
                You can download the archived files by right-clicking on the
                links and selecting "Save target"
            </article>

<?php

echo $Generator->loadProgramEpisodes("episodes-be-prepared.yml");
